...
from imake_humanoid_robot_assets.robots.imake_humanoid_robot import IMAKE_HUMANOID_ROBOT_CFG, IMAKE_HUMANOID_ROBOT_JOINTS
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        joint_pos = ObsTerm(
            ...
            params={"asset_cfg": SceneEntityCfg("robot", joint_names=IMAKE_HUMANOID_ROBOT_JOINTS, preserve_order=True)},
            noise=Unoise(n_min=-0.05, n_max=0.05),
        )
        joint_vel = ObsTerm(
...
class ActionsCfg:
    ...
    joint_pos = mdp.JointPositionActionCfg(
        asset_name="robot",
        joint_names=IMAKE_HUMANOID_ROBOT_JOINTS,
        scale=0.25,
        preserve_order=True,
...
class RewardsCfg:
    ...
    dof_torques_l2 = RewTerm(
        ...
        params={"asset_cfg": SceneEntityCfg("robot", joint_names=IMAKE_HUMANOID_ROBOT_JOINTS)},
        weight=-2.0e-5,
    )
    dof_acc_l2 = RewTerm(
...
@configclass
class ImakeHumanoidRobotEnvCfg(LocomotionVelocityEnvCfg):
    ...
    def __post_init__(self):
        ...
        # Scene
        self.scene.robot = IMAKE_HUMANOID_ROBOT_CFG.replace(prim_path="{ENV_REGEX_NS}/robot")
